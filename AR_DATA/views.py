...
name_list = ["이승현", "이민주", "길상현", "김준호" ,"박지훈", "최수현", "장민호", "홍길동", "김영희", "이영수", "한지민", "윤서준", "정하늘",
    "강지훈", "신수아", "박서현", "김민성", "이수정", "문수빈", "최준혁", "서유진", "박주형",
    "유재석", "김지수", "송은지", "장윤서", "정민호", "오수진", "임준영", "황수현"]
...
def stamp_data(request):
    ...
    for i in range(80):
        dic = dict()
        tour_entry = Tour_place.objects.get(tour_id = i)
